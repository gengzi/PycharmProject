...
#     // 过滤无关请求，只关注特定请求
#     if (oSession.fullUrl.Contains("120.55.151.61")){
#     oSession.utilDecodeResponse(); // 消除保存的请求可能存在乱码的情况
#     var fso;
#     var file;
#     fso = new ActiveXObject("Scripting.FileSystemObject");
#     var responsestr = oSession.GetResponseBodyAsString();
#     // var jsondata  =Fiddler.WebFormats.JSON.JsonDecode(responsestr);
#     // FiddlerObject.log(jsondata); // 可在控制台中输出Log
#     // 文件保存路径，可自定义
#     file = fso.OpenTextFile("H:\\python\\xiakeliao\\xiakaliaodata"+currentdate+".json", 8, true, true);
#     // file.writeLine("Response code: " + oSession.responseCode);
#     file.writeLine(responsestr);
#     // file.writeLine("\n");
#     file.close();
#     }
#     }
